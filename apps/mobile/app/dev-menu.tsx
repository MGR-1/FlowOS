// apps/mobile/app/dev-menu.tsx
// Dev navigation shortcuts. This was app/index.tsx until index became the
// session routing gate; the content is unchanged apart from the sign-out
// control, which is the only way to get back to the sign-in screen while
...
export default function DevMenuScreen() {
  ...
  return (
    <ScrollView style={styles.scroll} contentContainerStyle={styles.container}>
      ...
      <Link href="/week-intention" asChild>
        <Button label="Week Intention" />
      </Link>
